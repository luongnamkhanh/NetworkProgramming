...
int main(int argc, char *argv[])
{
    ...
    server_address.sin_addr.s_addr = htonl(INADDR_ANY); /* INADDR_ANY puts your IP address automatically */
    server_address.sin_port = htons(atoi(argv[1]));     /* Remember htons() from "Conversions" section? =) */
